...
import { _log, _addConfig, _setConfig, _setConfigs, _setFilePath, _setState, _setStatus, _addTemplate, _setTemplates, _setTemplate } from "./actioncreators";
...
const ReduxAccessor = () => {
  ...
  return { log, setState, setStatus, setFilePath, addConfig, setConfig, setConfigs, addTemplate, setTemplates, setTemplate, state, status, filepath, config, configs, logs, templates, template };
};
